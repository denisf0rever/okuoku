            ...
            <div class="form__wrapper">
              <form action="{{ route('dashboard.article.create-article') }}" method="post" class="form__inner-form" enctype="multipart/form-data">
                ...
                <div class="form__inner">
                    ...
                    <div class="form__tab form__tab-active">
                      <ul class="form__inputs">
                        ...
                        <li class="form__input-wrapper">
                          ...
                          <input class="form__input @error('title')error @enderror" type="text" id="title" name="title">
                        </li>
                        <li class="form__input-wrapper">
                          <label class="form__label" for="title">Заголовок статьи</label>
                          <input class="form__input @error('h1')error @enderror" type="text" id="h1" name="h1">
                        </li>
                        <li class="form__input-wrapper">
                          <label class="form__label" for="subtitle">Подзаголовок</label>
                          <input class="form__input @error('subtitle')error @enderror" type="text" id="subtitle" name="subtitle">
                        </li>
                        <li class="form__input-wrapper">
                          <label class="form__label" for="Meta-description">Метаописание</label>
                          <input class="form__input @error('metadescription')error @enderror" type="text" id="Meta-description" name="metadescription">
                        </li>
                        <li class="form__input-wrapper">
                          <label class="form__label" for="Metakeys">Метаключи</label>
                          <input class="form__input @error('metakey')error @enderror" type="text" id="Metakeys" name="metakey">
                        </li>
                        <li class="form__input-wrapper">
                          <label class="form__label" for="authorID">ID Автора</label>
                          <input class="form__input @error('author_id')error @enderror" type="text" id="author-id" name="author_id">
                        </li>
                        <li class="form__input-wrapper">
                          <label class="form__label" for="reading-time">Время прочтения</label>
                          <input class="form__input @error('reading-time')error @enderror" type="text" id="reading-time" name="reading-time">
                        </li>
                      </ul>
                      <label class="form__label-photo">
                        ...
                        <input class="form__input-photo @error('image')error @enderror" type="file" name="image" accept="image/*">
                      </label>
                    </div>
                  ...
                  <div class="form__status-wrapper">
                    <div class="form__select-wrapper">
                      ...
                      <input class="form__status-current @error('category')error @enderror" name="category" type="text" value="0" readonly>
                ...
                <div class="form__textarea-wrapper">
                  ...
                  <textarea name="short_text @error('short_text')error @enderror" id="" class="form__textarea"></textarea>
                </div>
                <div class="form__textarea-wrapper">
                  <div class="form__textarea-title">Содержаните статьи</div>
                  <textarea name="content" id="" class="form__textarea @error('content')error @enderror"><ul class="article__content-list"><li class="article__content-item"></li></ul></textarea>
                </div>
                <div class="form__textarea-wrapper">
                  <div class="form__textarea-title">Полный текст</div>
                  <textarea name="full_text" id="" class="form__textarea"></textarea>
                  <input class="form__submit @error('full_text')error @enderror" type="submit"> </input>
                </div>
              </form>
            </div>
          </section>
